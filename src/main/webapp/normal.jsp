...
<a href="${servletPath}?category=${cat.categoryId}" class="list-group-item list-group-item-action" id="category${cat.categoryId}" onclick="makeActive('category${cat.categoryId}')">${cat.categoryTitle}</a>
</c:forEach>
</div>
</div>
...
<%
int total=((List<Product>)request.getAttribute("products")).size();
if(total>6)
{
int pageNumber=1;
